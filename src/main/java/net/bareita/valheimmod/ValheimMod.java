package net.bareita.valheimmod;

import com.mojang.logging.LogUtils;
import net.bareita.valheimmod.entity.ModEntities;
import net.bareita.valheimmod.entity.client.DeerRenderer;
import net.bareita.valheimmod.entity.client.EikthyrRenderer;
import net.bareita.valheimmod.entity.client.TrollRenderer;
...
import net.bareita.valheimmod.item.ModCreativeModTabs;
...
@Mod(ValheimMod.MODID)
public class ValheimMod
{
    // Define mod id in a common place for everything to reference
    public static final String MODID = "valheimmod";
    ...
    public static class ClientModEvents
    {
        ...
        public static void onClientSetup(FMLClientSetupEvent event)
        {
            ...
            EntityRenderers.register(ModEntities.EIKTHYR.get(), EikthyrRenderer::new);
            EntityRenderers.register(ModEntities.SPEAR_ENTITY.get(), ThrownItemRenderer::new);

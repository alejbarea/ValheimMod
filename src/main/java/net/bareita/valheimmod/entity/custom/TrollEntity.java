...
public class TrollEntity extends Animal {
    ...
    private static final EntityDataAccessor<Boolean> ATTACKING = SynchedEntityData.defineId(TrollEntity.class, EntityDataSerializers.BOOLEAN);
    public TrollEntity(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new TrollAttackGoal(this, 1.0D, true));
    ...
    public boolean checkSpawnRules(LevelAccessor pLevel, MobSpawnType pSpawnReason) {
        return pLevel.getBrightness(LightLayer.SKY, this.blockPosition()) < 8;
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob pOtherParent) {
        return ModEntities.TROLL.get().create(pLevel);
    }

    @Override
    protected @Nullable SoundEvent getAmbientSound() {
        return ModSounds.TROLL_AMBIENT.get();
    }

    @Override
    protected @Nullable SoundEvent getHurtSound(DamageSource pDamageSource) {
        return ModSounds.TROLL_HURT.get();
    }

    @Override
    protected @Nullable SoundEvent getDeathSound() {
        return ModSounds.TROLL_DEATH.get();
    }
}
